                            ...
                            <table id="collapse-table"
                                    ...
                                    <tr data-tt-id="1-1-1" data-tt-parent-id="1-1">
                                        ...
                                        <td class="text-center">
                                            <a class="btn bg-olive btn-xs"
                                               onclick="javascript:deleteRole('${role.id}','${user.id}')">删除</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                <tr data-tt-id="1-2" data-tt-parent-id="0">
                                    <td colspan="3">权限</td>
                                </tr>
                                <c:forEach items="${role.permissions}" var="permission">
                                    <tr data-tt-id="1-2-1" data-tt-parent-id="1-2">
                                        ...
                                        <td class="text-center">
                                            <a class="btn bg-olive btn-xs"
                                               onclick="javascript:deletePermission('${permission.id}','${role.id}','${user.id}')">删除</a>
                                        </td>
                                    </tr>
                                </c:forEach>
