						...
						<div class="table-box">
							...
							<div class="box-tools pull-right">
								<div class="has-feedback">
									<form id="search" action="${pageContext.request.contextPath}/orders/findAll" method="post">
							...
							<div class="box-tools pull-right">
								<div class="has-feedback">
									<form id="search1" action="${pageContext.request.contextPath}/orders/findAll" method="post">
									<input type="text" name="sth" class="form-control input-sm"
										placeholder="搜索"></form> <span
										class="glyphicon glyphicon-search form-control-feedback" onclick="search1()"></span>
								</div>
							</div>
							<!--工具栏/-->
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
							...
							<c:forEach begin="1" end="${pageInfo.pages}" var="i">
								<li><a href="${pageContext.request.contextPath}/orders/findAll?page=${i}&pageSize=${pageInfo.pageSize}">${i}</a></li>
							</c:forEach>
